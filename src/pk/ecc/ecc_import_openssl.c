...
int ecc_import_openssl(const unsigned char *in, unsigned long inlen, ecc_key *key)
{
   ...
   LTC_SET_ASN1           (seq_priv, 2, LTC_ASN1_CUSTOM_TYPE,       custom,     1UL);
   LTC_SET_ASN1           (seq_priv, 3, LTC_ASN1_CUSTOM_TYPE,       custom + 1, 1UL);
   LTC_SET_ASN1_IDENTIFIER(seq_priv, 2, LTC_ASN1_CL_CONTEXT_SPECIFIC, LTC_ASN1_PC_CONSTRUCTED, 0); /* context specific 0 */
   LTC_SET_ASN1_IDENTIFIER(seq_priv, 3, LTC_ASN1_CL_CONTEXT_SPECIFIC, LTC_ASN1_PC_CONSTRUCTED, 1); /* context specific 1 */
